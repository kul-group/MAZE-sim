...
if __name__ == '__main__':
    ...
    bond_param_dict = {('Al', 'Cu'): [1.0, 1.0, 0.1], ('O-Cu', 'Cu'): [1.1, 2.0, 0.1], ('O-EF', 'Cu'): [1.2, 4.0, 0.2]}
    angle_param_dict = {('Cu', 'O-EF', 'Cu'): [2.3, 100]}
    ...
    for config_tag, info_list in info_dict.items():
        ff_forces = get_FF_forces(info_list[0], info_list[1], info_list[2], info_list[3], bond_param_dict, info_list[4],
                                  info_list[5], angle_param_dict)[11]
    ...
    def get_residue(param):
        ...
        angle_param_dict = {tuple(included_angle_type[0]): list(param[9:11])}

        predicted_f = []
        for config_tag, info_list in info_dict.items():
            ff_forces = get_FF_forces(info_list[0], info_list[1], info_list[2], info_list[3], bond_param_dict,
                                      info_list[4], info_list[5], angle_param_dict)[11]
    ...
    def get_fitting_parameters(initial_param):
    ...
    initial_param_dict = {('Al', 'Cu'): [1.0, 1.0, 0.1], ('O-Cu', 'Cu'): [1.1, 2.0, 0.1],
                          ('O-EF', 'Cu'): [1.2, 4.0, 0.2], ('Cu', 'O-EF', 'Cu'): [2.3, 100]}

    print(get_fitting_parameters([1.0, 1.0, 0.1, 1.1, 2.0, 0.1, 1.2, 4.0, 0.2, 2.3, 140.0]))
